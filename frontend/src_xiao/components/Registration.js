    ...
    return (
        <div className='row'>
            {regisFinished ?
                ...
                <div className="reactForm col-10 col-md-6 text-center px-0 py-5 mt-5">
                ...
                : <form className="reactForm col-10 col-md-6 text-center px-0 mt-5" onSubmit={handleSubmit}>
