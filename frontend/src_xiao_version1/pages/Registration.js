  ...
  const handleSubmit = (e) => {
    ...
    if (usernameErr || passwordErr || rePasswordErr || emailErr) {
      ...
      axios
        ...
        .then((res) => {
          if (res.data.success) {
            setRegisFinished(true); //set regisFinished to true, show message
          }
        })
        .catch((err) => {
          console.log(err);
  ...
  return (
    <div className="row">
      {regisFinished ? (
        ...
        <form
          className="reactForm col-10 col-md-6 text-center px-0"
          ...
          <div className="form-body">
            ...
            <div>
              ...
              <p className="inputErr">
                {" "}
                {usernameErr ? "* Username must have 3-10 characters" : ""}{" "}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="inputErr">
                {" "}
                {passwordErr
                  ? "* Password must have at least one letter, at least one number, and at least 6 characters"
                  : ""}{" "}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="inputErr">
                {" "}
                {rePasswordErr ? "* Password doesn't match" : ""}{" "}
              </p>
            </div>
